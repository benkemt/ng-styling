...
@Component({
  selector: 'app-styling-angular',
  standalone: true,
  imports: [StyleInTemplateComponent, StyleInTemplateWithLinkComponent, StyleInTemplateWithLinkAndImportComponent, HostPseudoClassComponent, HostContextPseudoClassComponent, ContentAndNgDeepComponent],
  template: `
...
export class StylingAngularComponent {
